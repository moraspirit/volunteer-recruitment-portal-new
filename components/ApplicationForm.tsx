...
export default function ApplicationForm() {
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className={`bg-zinc-950 p-6 md:p-8 rounded-2xl shadow-xl border max-w-4xl mx-auto transition-all ${isFormClosed ? 'opacity-50 border-zinc-900' : 'border-zinc-800'}`}>
        {serverError && (
          <div className="p-4 mb-4 bg-red-950/50 border border-red-500/50 text-red-200 rounded-xl text-sm font-medium">
            {serverError}
          </div>
        )}
        <fieldset disabled={isFormClosed} className="space-y-8">
