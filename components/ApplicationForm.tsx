              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
                {dropdownData.pillars.map((pillar) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`w-5 h-5 rounded-md flex items-center justify-center border transition-colors ${isSelected ? "bg-zinc-900 border-zinc-900 text-white" : "border-zinc-300 bg-transparent"
                        }`}>
                        {isSelected && (
